								...
								if self.player.moves - 1 >= 0:
									if self.activeDot.pos[1] == dot.pos[1]:
										if Vec2(dot.pos[0], dot.pos[1]).GetEuclideanDistance(self.activeDot.pos) == self.activeDot.spacing[0]:					
											if self.activeDot.pos[0] < dot.pos[0] and not self.activeDot.lines["right"]:
												self.activeDot.lines["right"] = True
												dot.lines["left"] = True
												self.player.moves -= 1
											
											elif self.activeDot.pos[0] > dot.pos[0] and not self.activeDot.lines["left"]:
										...
										if Vec2(dot.pos[0], dot.pos[1]).GetEuclideanDistance(self.activeDot.pos) == self.activeDot.spacing[1]:
											if self.activeDot.pos[1] < dot.pos[1] and not self.activeDot.lines["bottom"]:
												self.activeDot.lines["bottom"] = True
												dot.lines["top"] = True
												self.player.moves -= 1
											elif self.activeDot.pos[1] > dot.pos[1] and not self.activeDot.lines["top"]:
